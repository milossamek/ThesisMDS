...
import com.MDS.ThesisMDS.backend.implementation.spaceFillingAlg.ZCurve;
...
@SpringComponent
@UIScope
public class ZOrderView extends VerticalLayout implements View {
    private LinearOrderingDrawComponent drawView;
    private ZCurve curve;
    @Autowired
    ...
    public ZOrderView() {
        super();
        this.curve = new ZCurve();
    }

    @PostConstruct
    private void postConstruct() {
        drawView = new LinearOrderingDrawComponent(curve, "ZOrder", _selectedPoint);
