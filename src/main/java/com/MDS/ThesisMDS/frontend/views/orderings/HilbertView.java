...
import com.MDS.ThesisMDS.backend.implementation.spaceFillingAlg.HilbertCurve;
...
@SpringComponent
@UIScope
public class HilbertView extends VerticalLayout implements View {
    ...
    public HilbertView() {
        super();
        this.curve = new HilbertCurve();
    }

    @PostConstruct
    private void postConstruct() {
        drawView = new LinearOrderingDrawComponent(curve, "Hilbert", _selectedPoint);
