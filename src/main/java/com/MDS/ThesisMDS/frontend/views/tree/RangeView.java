...
import com.MDS.ThesisMDS.backend.implementation.RangeTreeImplementation;
...
import com.MDS.ThesisMDS.frontend.gwt.client.implemenation.RangeTreeProcessing;
...
@SpringComponent
@UIScope
public class RangeView extends ADrawForm implements View {
    ...
    public RangeView() {
        ...
        tree = new RangeTreeImplementation();
    }

    @PostConstruct
    private void postConstruct() {
        dataStructureDrawComponent = new DataStructureDrawComponent(_bulkForm, _editForm, database, tree, TreeType.ttRangeTree, RangeTreeProcessing.class.getName());
    ...
    public void beforeLeave(ViewBeforeLeaveEvent event) {
        if (((MyVaadinUI) MyVaadinUI.getCurrent()).getLastView() != null && ((MyVaadinUI) MyVaadinUI.getCurrent()).getLastView().getClass().equals(RangeView.class)) {
