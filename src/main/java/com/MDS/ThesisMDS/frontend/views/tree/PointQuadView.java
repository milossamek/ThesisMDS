...
import com.MDS.ThesisMDS.backend.implementation.PointBasedQTImplementation;
...
@SpringComponent
@UIScope
public class PointQuadView extends ADrawForm {
    ...
    public PointQuadView() {
        super();
        this.setMargin(false);
        tree = new PointBasedQTImplementation();
    }

    @PostConstruct
    private void postConstruct() {
        dataStructureDrawComponent = new DataStructureDrawComponent(_bulkForm, _editForm, database, tree, TreeType.ttQuadTreePoint, QuadTreeProcessing.class.getName());
    ...
    public void beforeLeave(ViewBeforeLeaveEvent event) {
        if (((MyVaadinUI) MyVaadinUI.getCurrent()).getLastView() != null && ((MyVaadinUI) MyVaadinUI.getCurrent()).getLastView().getClass().equals(PointQuadView.class)) {
